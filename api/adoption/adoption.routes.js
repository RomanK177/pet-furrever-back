...
const { getAdoptionRequests, getAdoptionRequest, removeAdoptionRequest, updateAdoptionRequest, createAdoptionRequest, sendMessage, markMessageAsUnread } = require('./adoption.controller.js');
